...
from python_execution_service.agentic_core.services.report_context import (
    build_report_context_memory,
    load_ignored_report_codes,
)
from python_execution_service.agentic_core.services.self_healing import (
    apply_self_healing,
            ...
            if state.converted_files:
                for file_path in state.converted_files:
                    try:
                        ...
                        path_obj.write_text(heal_result.fixed_code, encoding="utf-8", newline="")
