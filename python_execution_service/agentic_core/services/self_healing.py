...
from python_execution_service.agentic_core.models.results import SelfHealResult
from python_execution_service.agentic_core.runtime.snowflake_session import get_snowflake_session
...
def write_code_to_temp_file(code: str, file_name: str = "temp_code.sql") -> str:
    ...
    with open(temp_file_path, "w", encoding="utf-8", newline="") as handle:
        handle.write(code)
